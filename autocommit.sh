...
# Jul 24, 2023 Initial Version from https://github.com/EricZimmerman/VoronTools/blob/main/autocommit.sh
###
...
### By default that is 'master', its now 'main' because you know slavery and such ..
branch=main
